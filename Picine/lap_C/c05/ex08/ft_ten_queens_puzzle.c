...
/*   Updated: 2022/02/10 17:14:52 by sungjpar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <unistd.h>

void	ft_print_arr(int *arr, const unsigned int n)
{
	unsigned int	i;
	char			c;
...
void	ft_n_queens_puzzle(int cur_idx, const int n, int *arr, int *result)
{
	int	cur_pos;
