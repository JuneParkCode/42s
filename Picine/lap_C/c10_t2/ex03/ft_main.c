...
/*   Updated: 2022/02/23 12:47:59 by sungjpar         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
#include <libgen.h>
#include <fcntl.h>
...
void	end_hexdump(int	argc, char *argv[], char *buf_current, char *buf_prev)
{
	int		flag;
	...
	{
		if (g_buf && argc > 1 && ft_strcmp(argv[1], "-C") == 0)
		{
			g_flag = 2;
...
int	main(int argc, char *argv[])
{
	...
	end_hexdump(argc, argv, buf_current, buf_prev);
	return (0);
}
